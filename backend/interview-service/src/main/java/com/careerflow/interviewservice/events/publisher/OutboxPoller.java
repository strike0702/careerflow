package com.careerflow.interviewservice.events.publisher;

import com.careerflow.events.CorrelationIdKafkaHelper;
import com.careerflow.events.EventObjectMappers;
import com.careerflow.interviewservice.events.outbox.OutboxEvent;
import com.careerflow.interviewservice.events.outbox.OutboxEventRepository;
import com.careerflow.interviewservice.events.outbox.OutboxEventStatus;
...
public class OutboxPoller {
    ...
    private final String interviewTopic;
    ...
    public OutboxPoller(
        ...
        @Value("${careerflow.events.interview-topic}") String interviewTopic,
